        ...
        <div className="landing-page">
            ...
            <section className="hero-section">
                <div className="hero-content">
                    <p className="hero-tag">ONLINE E-RICKSHAW BOOKING</p>
                    <h1>
                        Your Ride,
                        <span> Your Way.</span>
                    </h1>
            ...
            <footer className="footer">
                <div className="footer-logo">E-Ride</div>
                <p>Online E-Rickshaw Booking System</p>
                <p className="copyright">© 2026 E-Rickshaw. All rights reserved.</p>
            </footer>
        </div>
    );
};
